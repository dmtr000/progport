...
- **Администрирование и модерация**  
  Администраторы могут управлять пользователями, курсами и контентом. Встроена автоматическая модерация сообщений с помощью Yandex GPT.
